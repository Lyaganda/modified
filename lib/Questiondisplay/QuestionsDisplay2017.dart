...
class QuestionDisplay2017 extends StatefulWidget {

  final String year;
  const QuestionDisplay2017(this.year) ;

  @override
  _QuestionDisplay2017State createState() => _QuestionDisplay2017State();
}

class _QuestionDisplay2017State extends State<QuestionDisplay2017> {
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child:Scaffold(
          appBar: AppBar(title: Text('Physics 2017 Section A'),),
          body: Container(
